# File    : ctrl_sixaxis2thruster.mk (for Release 2010b and later)
#
# Abstract:
...
MAKECMD         = c:\gccdist\supplemental\setup-gcc.bat && make
HOST            = PC
BUILD           = yes
...
MODULES         		= ctrl_sixaxis2thruster_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/ctrl_sixaxis2thruster_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
