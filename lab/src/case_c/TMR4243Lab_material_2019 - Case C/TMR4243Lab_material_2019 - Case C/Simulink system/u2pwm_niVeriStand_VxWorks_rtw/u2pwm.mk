# File    : u2pwm.mk (for Release 2010b and later)
#
# Abstract:
...
MODEL           		= u2pwm
MODULES         		= ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c u2pwm_data.c 
MAKEFILE        		= u2pwm.mk
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/u2pwm_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
